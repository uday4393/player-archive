# Simple Player Archive

This is a simple React SPA with demo of features like React Components, Typescript, Tailwind CSS to name a few.

## DEMO 
![alt text](https://github.com/uday4393/player-archive/blob/master/demo/app-demo.gif?raw=true)
